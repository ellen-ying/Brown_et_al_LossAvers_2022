...
plot_1.1_lambda0 <- 
  ...
  geom_text(aes(x = 2.05, y = 9.5, label = lambda0_mean), 
            hjust = 1, inherit.aes = FALSE) +
  geom_text(aes(x = 2.05, y = 9, label = lambda0_PI), 
            hjust = 1, inherit.aes = FALSE) +
...
plot_1.1_sigma <- 
  ...
  geom_segment(data = sigma_stats, 
               aes(x = PI_LL, xend = PI_UL, y = 0, yend = 0),
               inherit.aes = FALSE, size = 3) +
  geom_text(aes(x = 0.98, y = 13, label = sigma_mean), 
            hjust = 1, inherit.aes = FALSE) +
  geom_text(aes(x = 0.98, y = 12.5, label = sigma_PI), 
            hjust = 1, inherit.aes = FALSE) +
